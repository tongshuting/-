...
function _showDynClicks(clicktype, owner, clickid)
{
    try
    {
        ...
        var url = '/static/code/news/click/dynclicks.jsp?clickid='+clickid+'&owner='+owner+'&clicktype='+clicktype;
...
function _showDynClickBatch(spanids,wbnewsids,clicktype, owner)
{
		...
		try
		{
				var url = '/static/code/news/click/dynclicksbatch.jsp?clickids='+usernewsids+'&owner='+owner+'&clicktype='+clicktype;
...
function _addDynClicks(clicktype, owner, clickid)
{
    try
    {
    	var url = '/static/code/news/click/addclicktimes.jsp?wburlid=' + clickid + '&owner=' + owner + '&type=' + clicktype;
        var xmlhttp = _dynClicks_ajax();
        xmlhttp.open("GET",url, true);
        xmlhttp.send();
    }
